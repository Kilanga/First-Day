...
export default function TermsPage() {
  return <main className="min-h-screen bg-white px-5 py-14 sm:px-8"><article className="surface-card mx-auto max-w-3xl p-7 sm:p-10">
    ...
    <div className="mt-8 space-y-7 text-sm leading-6 text-slate-700">
      ...
      <section><h2 className="text-lg font-semibold text-slate-900">Acceptable use</h2><p className="mt-2">Do not use the service to upload unlawful material, personal or confidential data without authority, malware, or material designed to disrupt the service. Do not attempt to bypass usage limits, access another person&apos;s onboarding desk, or share an onboarding link where its contents must remain private.</p></section>
      <section><h2 className="text-lg font-semibold text-slate-900">Shared onboarding</h2><p className="mt-2">Shared links are not access-controlled. Anyone with a valid link can open the reusable template. Disable or rotate a link if it was sent to the wrong person or no longer needs to be available.</p></section>
      <section><h2 className="text-lg font-semibold text-slate-900">Availability</h2><p className="mt-2">The service is provided as available and may change, be limited, or be discontinued. Keep any important source material outside First Day; deleting your browser data or your onboarding desk can prevent access to your onboarding history.</p></section>
    </div>
  </article></main>;
}
