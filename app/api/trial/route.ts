...
export async function POST(request: Request) {
  try {
    ...
    if (!(await consumeAiActionQuota(mentorId, "trial"))) return NextResponse.json({ error: "The learning space is closed for today — come back tomorrow." }, { status: 429 });
