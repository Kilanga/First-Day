...
export default function OnboardingPage() {
  return <main className="min-h-screen bg-[#faf9f7] px-5 py-14 sm:px-8"><div className="mx-auto max-w-2xl">
    ...
    <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Give your learning partner a subject</h1>
