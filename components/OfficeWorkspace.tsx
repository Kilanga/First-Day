...
type WorkspaceSubject = { id: string; title: string; firstQuestion?: string; hire: HireView; activeSession: { id: string; messages: ChatMessage[] } | null };
