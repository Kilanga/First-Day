...
export default function OfficeWorkspace({ subjectId, title, name, initialQuestion }: Props) {
  ...
  return <main className="min-h-screen bg-[#faf9f7] text-slate-800">
    ...
    <div className="mx-auto max-w-6xl px-5 py-6 sm:px-8 lg:py-10">
      ...
      {agendaComplete ? <div className="mb-5 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-3 text-center text-sm font-semibold text-emerald-900">That was a great study session - I got everything on my list!</div> : null}
