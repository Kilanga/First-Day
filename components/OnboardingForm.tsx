...
export default function OnboardingForm() {
  ...
  function enterOffice() {
    if (!created) return;
    router.push(`/office?${new URLSearchParams({ subjectId: created.subjectId, title, hireName: created.hire.name, firstQuestion: created.firstQuestion })}`);
  }
