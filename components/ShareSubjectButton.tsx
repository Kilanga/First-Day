...
export default function ShareSubjectButton({ subjectId, initiallyShared }: { subjectId: string; initiallyShared: boolean }) {
  ...
  async function disable() {
    if (status === "working" || !window.confirm("Disable this shared link? Anyone opening it will no longer be able to start this onboarding.")) return;
    setStatus("working");
    try {
